...
public class Constants {
    ...
    // change the following input and output paths to your local ones
    public static final String FILE_PATH_REDDIT = "C:\\Lucene\\Data\\RedditJokes\\reddit_jokes.json";
    
    // modify to your index path
    public static final String INDEX_PATH_REDDIT = "C:\\Lucene\\Index\\index_redditJokes";
